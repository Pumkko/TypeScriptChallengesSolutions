...
// needed help for that one, i had it except i did not check for extends Function
// That means that a: () => 22 became DeepReadonly<..> wich fails the test
